...
public class GameFilterPrefs {
	...
	public GameFilterPrefs(GamePlayActivity value){
		mm = value;
	}
	...
	public boolean readValues(){
		...
		value = getSharedPreferences().getBoolean(PrefsHelper.PREF_FILTER_FAVORITES,false) ? 1 : 0;
		b = value!= favorites || b; favorites = value;
		value = getSharedPreferences().getBoolean(PrefsHelper.PREF_FILTER_CLONES,false) ? 1 : 0;
		b = value!= clones || b; clones = value;
		value = getSharedPreferences().getBoolean(PrefsHelper.PREF_FILTER_NOTWORKING,false)  ? 1 : 0;
		b = value!= not_working || b; not_working = value;
		value = Integer.valueOf(getSharedPreferences().getString(PrefsHelper.PREF_FILTER_YGTE,"-1")).intValue();
		b = value!= gte_year || b; gte_year = value;
		value = Integer.valueOf(getSharedPreferences().getString(PrefsHelper.PREF_FILTER_YLTE,"-1")).intValue();
		b = value!= lte_year || b; lte_year = value;
		value = Integer.valueOf(getSharedPreferences().getString(PrefsHelper.PREF_FILTER_MANUF,"-1")).intValue();
		b = value!= manufacturer || b; manufacturer = value;
		value = Integer.valueOf(getSharedPreferences().getString(PrefsHelper.PREF_FILTER_CATEGORY,"-1")).intValue();
		b = value!= category || b; category = value;
		value = Integer.valueOf(getSharedPreferences().getString(PrefsHelper.PREF_FILTER_DRVSRC,"-1")).intValue();
